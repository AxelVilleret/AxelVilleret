...
<table>
  <tr>
    ...
    <tr>
        <td style="font-weight: bold; padding-right: 10px; vertical-align: center; border: none;">Web Services:</td>
        <td><img height="40" src="https://skillicons.dev/icons?i=soap,rest,graphql"/></td>
    </tr>
    <tr>
        <td style="font-weight: bold; padding-right: 10px; vertical-align: center; border: none;">Other Tools:</td>
        <td><img height="40" src="https://skillicons.dev/icons?i=figma,postman,wordpress,jira"/></td>
    </tr>
    <tr>
